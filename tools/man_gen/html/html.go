...
func MakeHtml(man_file string,version_file string) {
	...
	writer.WriteString("<section><h1>NAME</h1><p>mkdotenv - A command-line tool that populates secrets upon a .env file from a template.\n<p></section>")

	writer.WriteString("<section><h1>DESCRIPTION</h1><p>\nThe <strong>mkdotenv</strong> command allows users to populate environmental variables from a template file by placing appropriate markup upon the file.</p></section>")
	...
	writer.WriteString("<h1>SYNOPSIS</h1><p>")
	writer.WriteString(synopsis_build.String())
	writer.WriteString("</p></section>")
