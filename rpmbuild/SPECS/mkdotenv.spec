...
- Initial RPM package
alpinebuild bin Changelog.md contrib-docs debian Dockerfile EMAIL fedora keyid LICENCE Makefile man mkdotenv NAME notes.txt ppa README.md RELEASE_NOTES rpmbuild TAR_FILES tools VERSION Τρι Μαρ 25 2025 Dimitrios Desyllas <pcmagas@disroot.org> - %{version}-1
